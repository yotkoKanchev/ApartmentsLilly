...
namespace ApartmentsLilly.Server.Data.Migrations
{
    ...
    [Migration("20201229214634_AddApartmentInRequestModel")]
    partial class AddApartmentInRequestModel
    {
            ...
            modelBuilder.Entity("ApartmentsLilly.Server.Data.Models.Reviews.Review", b =>
                {
                    ...
                    b.HasOne("ApartmentsLilly.Server.Data.Models.Bookings.Booking", "Booking")
                        .WithOne("Review")
                        .HasForeignKey("ApartmentsLilly.Server.Data.Models.Reviews.Review", "BookingId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();
